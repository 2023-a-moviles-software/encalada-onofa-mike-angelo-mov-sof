...
class BMarcaReloj (nombre: String, paisOrigen: String, fechaFundacion: String, ratingPopularidad: Int){
    ...
    constructor(id: String, nombre: String, paisOrigen: String, fechaFundacion: String, ratingPopularidad: Int): this(nombre, paisOrigen, fechaFundacion, ratingPopularidad){
        this.id = id
    }
